...
/**
 *
 * Defers determining the viability of a failure for retry to a RetryCallFilter implementation.
 *
 * @author sfloess
 *
 */
public class FilteredRetryCaller<V> extends AbstractRetryCaller<V> {
     ...
     */
    @Override
    protected boolean isToRetryCall(Call<V> call, Exception failure) throws Exception {
        return getRetryCallFilter().isToRetryCall(call, failure);
    }

    /**
     * This constructor sets the object who filters retries and the maximum number
     * of retries allowed upon failure.
     *
     * @param callStrategy is the strategy to use when performing our call.
     * @param retryCallFilter the object who filters failures for retry viability.
     * @param maxRetries the maximum number of retries allowed.
     *
     * @throws IllegalArgumentException if callStrategy or retryCallFilter is null or maxRetries is less than 1.
     */
     ...
     * @param maxRetries the maximum number of retries allowed.
     *
     * @throws IllegalArgumentException if retryCallFilter is null or maxRetries is less than 1.
     */
    ...
    /**
     * This constructor sets the object who filters retries.  The maximum number of retries will be
     * the maximum value for an integer (Integer.MAX_VALUE).
     *
     * @param retryCallFilter the object who filters failures for retry viability.
     *
