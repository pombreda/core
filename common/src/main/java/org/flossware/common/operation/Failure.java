 ...
 */
public interface Failure<V> {

    /**
     * Called when an operation failed.
     *
     * @param obj     being operated upon when a failure arose.
     * @param failure is what arose when operating upon <code>obj</code>.
     */
    void failed(V obj, Throwable failure);
}
